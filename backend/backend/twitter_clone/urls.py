...
urlpatterns = [
    ...
    path('my-profile/', views.CurrentUserProfileView.as_view(),
         name='my-profile'),
    path('my-profile/likes/', views.CurrentUserLikeListView.as_view(),
         name='my-profile-likes'),
    path('my-profile/replies/', views.CurrentUserRepliesListView.as_view(),
